...
import type { FormState, TaskItemType } from "@/types/new-tab"
...
export function TaskItem({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative flex w-full items-center gap-2 rounded-md p-1.5 transition-colors hover:bg-secondary/75",
    ...
    >
      ...
      <Checkbox
        ...
        disabled={isTogglePending || isEditing || isQuickDeletePending}
        className="ml-1"
      />
      ...
      {!isEditing && item.is_completed && taskType === "general" && (
        <Button
          variant="ghost"
          size="icon"
